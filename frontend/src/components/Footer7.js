...
const Footer7 = () => {
  return (
    <footer className="ml-[-15.5px] w-[1920px] bg-gray-900 flex flex-col items-start justify-start pt-20 px-0 pb-0 box-border gap-[80px] max-w-[102%] shrink-0 text-justify text-sm text-gray-white font-body-medium-400 mq450:gap-[20px_80px] mq450:pt-[52px] mq450:box-border mq900:gap-[40px_80px]">
      <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
        <div className="w-[1329px] flex flex-row items-start justify-start py-0 px-0 box-border gap-[35px] max-w-full mq900:gap-[35px_17px] mq1600:flex-wrap">
