...
const Sidebar = () => {
  return (
    <div className="absolute h-full top-[0px] bottom-[0px] left-[0px] bg-gray-900 shadow-[0px_-1px_0px_#363b47_inset] w-[280px] text-left text-sm text-gray-500 font-body-medium-400">
