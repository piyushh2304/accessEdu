  ...
  return (
    <div className="self-stretch flex-1 flex flex-col items-start justify-start text-left text-sm text-gray-500 font-body-medium-400">
      ...
      <div className="self-stretch flex-1 bg-primary-500 overflow-hidden flex flex-row items-start justify-start py-3 px-6">
        <div className="self-stretch w-[91px] flex flex-row items-start justify-start gap-[12px]">
          <img
            className="h-6 w-6 relative min-h-[24px]"
            alt=""
            src="/gear1.svg"
          />
          <input
            className="w-[calc(100%_-_24px)] [border:none] [outline:none] bg-[transparent] h-[22px] flex-1 flex flex-col items-start justify-start pt-0.5 px-0 pb-0 box-border font-body-medium-400 font-medium text-sm text-gray-white min-w-[33px]"
