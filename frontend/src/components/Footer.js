...
const Footer = ({ propMarginTop }) => {
  ...
  return (
    <footer
      className="self-stretch bg-gray-900 flex flex-col items-start justify-start pt-20 px-0 pb-0 box-border gap-[80px] max-w-full text-justify text-sm text-gray-white font-body-medium-400 lg:gap-[40px_80px] mq825:gap-[20px_80px] mq450:pt-[52px] mq450:box-border"
      style={footer1Style}
    >
