...
import CompanyNetflixGrayFalse from "../components/CompanyNetflixGrayFalse";
...
const Homepage = () => {
  return (
    <div className="w-full relative bg-gray-white overflow-hidden flex flex-col items-start justify-start tracking-[normal]">
      ...
      <section className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[94px] box-border max-w-full text-left text-13xl text-gray-900 font-body-medium-400 mq450:pb-[61px] mq450:box-border">
        <div className="flex-1 overflow-x-auto flex flex-row items-center justify-center py-20 px-[300px] box-border gap-[24px] max-w-full mq850:pl-[75px] mq850:pr-[75px] mq850:box-border mq1225:pl-[150px] mq1225:pr-[150px] mq1225:box-border">
          <div className="w-[424px] shrink-0 flex flex-col items-start justify-start gap-[24px] max-w-full">
            <h1 className="m-0 self-stretch relative text-inherit tracking-[-0.01em] leading-[40px] font-semibold font-inherit mq850:text-7xl mq850:leading-[32px] mq450:text-lgi mq450:leading-[24px]">
              Our trusted platforms
            </h1>
            <div className="w-[312px] relative text-sm tracking-[-0.01em] leading-[22px] text-gray-600 inline-block">
              Together, we can make a difference in the lives of individuals
              with different abilities and create a more inclusive society for
              all.
            </div>
          </div>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-col items-start justify-start">
            <div className="bg-gray-white shadow-[0px_0px_32px_rgba(9,_26,_68,_0.07)] flex flex-row items-center justify-center py-0 px-[50px]">
              <CompanyNetflixGrayFalse
                companyNetflixGrayFalseCo="/company-logo.svg"
                companyNetflixGrayFalseIcWidth="100px"
                companyNetflixGrayFalseIcHeight="100px"
                companyNetflixGrayFalseIcPosition="relative"
              />
            </div>
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-col items-start justify-start">
            <div className="bg-gray-white shadow-[0px_0px_32px_rgba(9,_26,_68,_0.07)] flex flex-row items-center justify-center py-0 px-[50px]">
              <CompanyNetflixGrayFalse
                companyNetflixGrayFalseCo="/company-logo-1@2x.png"
                companyNetflixGrayFalseIcWidth="100px"
                companyNetflixGrayFalseIcHeight="100px"
                companyNetflixGrayFalseIcPosition="relative"
              />
          ...
          <Column nFB="NFB" />
          <Column nFB="NCLD" propMinWidth="127px" propColor="#1f55e1" />
        </div>
      </section>
      <Footer2 />
    </div>
