...
const Footer1 = ({ propOverflowX }) => {
  ...
  return (
    <footer className="self-stretch bg-gray-900 flex flex-col items-start justify-start pt-20 px-0 pb-0 box-border gap-[80px] max-w-full text-justify text-sm text-gray-white font-body-medium-400 mq450:pt-[52px] mq450:box-border mq925:gap-[20px_80px] mq1350:gap-[40px_80px]">
      <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
        <div
          className="w-[1329px] flex flex-row items-start justify-start py-0 px-0 box-border gap-[35px] max-w-full mq925:gap-[35px_17px] mq1350:flex-wrap"
          style={footerStyle}
        >
      ...
      <div className="self-stretch bg-gray-900 shadow-[0px_1px_0px_rgba(54,_59,_71,_0.5)_inset] flex flex-row items-start justify-between py-6 px-[300px] box-border max-w-full gap-[20px] text-gray-500 mq925:pl-[75px] mq925:pr-[75px] mq925:box-border mq1350:flex-wrap mq1350:justify-center mq1350:pl-[150px] mq1350:pr-[150px] mq1350:box-border">
        ...
        <select className="w-[200px] bg-gray-900 box-border overflow-hidden shrink-0 flex flex-row items-start justify-start py-3 px-[17px] font-body-medium-400 text-base text-gray-500 border-[1px] border-solid border-gray-800">
