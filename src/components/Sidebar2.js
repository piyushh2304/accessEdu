...
const Sidebar2 = ({ informationsHeight, informationsMinWidth }) => {
  const sidebar1Style = useMemo(() => {
    return {
      height: informationsHeight,
      minWidth: informationsMinWidth,
    };
  }, [informationsHeight, informationsMinWidth]);

  return (
    <div
      className="h-[1118px] w-[280px] relative bg-gray-900 shadow-[0px_-1px_0px_#363b47_inset] text-left text-sm text-gray-500 font-body-medium-400 lg:hidden"
      style={sidebar1Style}
    >
        ...
        <div className="self-stretch flex-1 flex flex-col items-start justify-start">
          ...
          <button className="cursor-pointer [border:none] py-3 px-6 bg-primary-500 self-stretch h-12 overflow-hidden shrink-0 flex flex-row items-start justify-start box-border">
            <div className="self-stretch flex flex-row items-start justify-start gap-[12px]">
              ...
              />
              <div className="flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
                <div className="relative text-sm tracking-[-0.01em] leading-[20px] font-medium font-body-medium-400 text-gray-white text-left inline-block min-w-[79px]">
                  My Courses
                </div>
              </div>
            </div>
