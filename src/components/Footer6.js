const Footer6 = () => {
  return (
    <footer className="self-stretch flex flex-row items-start justify-between py-5 px-40 box-border gap-[20px] max-w-full text-center text-sm text-gray-600 font-body-medium-400 mq1400:flex-wrap mq1400:justify-center">
